...
import io.elapse.stocks.activities.LoginActivity;

public class StocksAuthenticator extends AbstractAccountAuthenticator {
	...
	public StocksAuthenticator(final Context context) {
		super(context);
		mContext = context;
	}
